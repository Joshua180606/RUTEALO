...
def setup_logging(log_dir: str = "logs", log_level: str = "INFO", is_production: bool = False) -> None:
    """
    ...
    if is_production:
        ...
        main_handler = logging.handlers.RotatingFileHandler(
            log_path / "application.log", maxBytes=10 * 1024 * 1024, backupCount=5  # 10 MB
        )
        ...
        error_handler = logging.handlers.RotatingFileHandler(
            log_path / "errors.log", maxBytes=5 * 1024 * 1024, backupCount=3  # 5 MB
        )
        ...
        file_handler = logging.handlers.RotatingFileHandler(
            log_path / "debug.log", maxBytes=10 * 1024 * 1024, backupCount=3  # 10 MB
        )
